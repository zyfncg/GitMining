...
//				StatConst.CHART_WIDTH, StatConst.CHART_HEIGHT);
		...
		int min1 = SMALL_STAR_HISTOGRAM.getMinNum();
		int max1 = SMALL_STAR_HISTOGRAM.getMaxNum();
		...
		int min2 = BIG_STAR_HISTOGRAM.getMinNum();
		int max2 = BIG_STAR_HISTOGRAM.getMaxNum();
